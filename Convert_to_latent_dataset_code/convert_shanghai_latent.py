...
# ================= CONFIGURATION =================
INPUT_H5_PATH = '/home/vatsal/NWM/Dataset/Shanghai_Radar/shanghai.h5'    # Input raw data
OUTPUT_H5_PATH = '/home/vatsal/NWM/Dataset/shanghai_latent_32/shanghai_latent_data.h5'     # Output encoded data
AE_CKPT = './Pretrained_ae_checkpoints/autoencoder_checkpoint_32_SHANGHAI.pth'      # VAE Checkpoint
IMG_SIZE = 128
...
def process_to_latents(model_instance):
    ...
    with h5py.File(INPUT_H5_PATH, 'r') as source_f, h5py.File(OUTPUT_H5_PATH, 'w') as target_f:
        ...
        for split_type in ['train', 'test']:
            ...
            keys = [k for k in source_f[split_type].keys() if k.isdigit()]
