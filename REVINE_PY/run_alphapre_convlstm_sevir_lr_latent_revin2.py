...
class Runner(object):
    ...
    def _train_batch(self, batch):
        ...
        last_frame = frames_in[:,-1:,]
        frames_in = frames_in-last_frame
        frames_out = frames_out-last_frame
    ...
    def _sample_batch(self, batch, use_ema=False, vis_diff=False):
        ...
        last_frame = radar_input[:,-1:,]
        radar_input = radar_input-last_frame
        radar_pred, *_ = sample_fn(radar_input,compute_loss=False)
        radar_pred = radar_pred+last_frame
