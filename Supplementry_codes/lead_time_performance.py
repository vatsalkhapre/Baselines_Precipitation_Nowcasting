...
csi = {
    ...
    'MAU':   np.array([0.0]*20),
    'Simvp':     np.array([0.0]*20),
    'EarthFormer(falfcl)': np.array([0.0]*20),
    'MAU(falfcl)': np.array([0.0]*20),
    ...
    'DAWN-Cast(falfcl)':      np.array([0.6526194995564145, 0.5826478892255537, 0.5255335592224464, 0.4797784564009146, 0.4415387799667591, 0.41053808669736314, 0.3841413064809876, 0.36202268895298156, 0.3422223225739474, 0.3239880384393596, 0.3082824500163499, 0.2949466946445149, 0.2824888274723574, 0.27026256982377683, 0.2594732150377678, 0.24928227264313862, 0.24014910638022524, 0.23084774112252535, 0.2220174550036925, 0.2146204915527857] ), 
}
...
model_styles = {
    ...
    'MAU'         : {'color': '#FF8C00', 'marker': 'p', 'ls': '-',  'lw': 1.5, 'ms': 4, 'zorder': 2},
    'Simvp':   {'color': '#20B2AA', 'marker': 'h', 'ls': '-',  'lw': 1.5, 'ms': 4, 'zorder': 2},
    'DiffCast':     {'color': '#CD5C5C', 'marker': 's', 'ls': '--', 'lw': 1.5, 'ms': 4, 'zorder': 2},
    'AlphaPre':     {'color': '#4169E1', 'marker': 'o', 'ls': '--', 'lw': 1.8, 'ms': 5, 'zorder': 3},
    'DAWN-Cast(falfcl)':    {'color': '#DC143C', 'marker': '*', 'ls': '-',  'lw': 2.5, 'ms': 8, 'zorder': 5},
    'EarthFormer_falfcl'
    'MAU_falfcl'
}
