python3 run_alphapre_convlstm_sevir_lr_latent.py \
    ...
    --ckpt_milestone "sftp://vatsal@10.24.52.66/home/vatsal/Dataserver/ICML26/BestModels/METEONET_LATENT/meteo_lr_latent_32/alpha_afnoamplinet_latent_falfcl_meteo_lr_latent_32_Testing_Integrity_with_afno_amplinet_0.01_1.0/checkpoints/ckpt-best.pt" \
    --eval \
