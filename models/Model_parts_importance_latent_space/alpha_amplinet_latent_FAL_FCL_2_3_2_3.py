...
class AmpTimeCell(nn.Module):
    def __init__(self, t_in, t_out, size_factor=1):
        ...
        # self.w1 = nn.Parameter((self.scale * torch.randn(2, t_in, t_out)))
        # self.b1 = nn.Parameter((self.scale * torch.randn(2, 1, 1, 1, t_out)))
    ...
    def forward(self, x):
        ...
        # x2 = torch.view_as_complex(torch.stack([x1_real, x1_imag], dim=-1))
