...
class AlphaPre(nn.Module):
    def __init__(self, total_steps, pre_seq_length, aft_seq_length, input_shape, input_dim, 
...
def get_model(
    ...
    **kwargs
    ...
    model = AlphaPre(total_steps, pre_seq_length=T_in, aft_seq_length=T_out, input_shape=input_shape, input_dim=img_channels, 
