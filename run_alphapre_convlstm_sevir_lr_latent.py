...
def create_parser():
    ...
    parser.add_argument("--exp_note",       type=str,   default='Amplinet_latent_32x32x4_falfcl',              help="additional note for experiment")
    ...
    parser.add_argument("--run_name",       type=str,   default='sevir_lr_latent_32_normalresized_amplinet_falfcl',        help="wandb run name")
