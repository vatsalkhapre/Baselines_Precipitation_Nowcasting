...
class Runner(object):
    ...
    def _train_batch(self, batch):
        ...
        mean_val = frames_in.mean()
        std_val = frames_in.std()
        frames_in = (frames_in-mean_val)/std_val
        frames_out = (frames_out-mean_val)/std_val
        # std_val = frames_in.std()
    ...
    def _sample_batch(self, batch, use_ema=False, vis_diff=False):
        ...
        mean_value = radar_input.mean()
        radar_input = (radar_input-mean_value)/std_value
        radar_pred, *_ = sample_fn(radar_input,compute_loss=False)
        radar_pred = (radar_pred*std_value)+mean_value
