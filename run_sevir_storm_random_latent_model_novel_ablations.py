...
from datasets.get_datasets_sevir_storm_random import get_dataset
...
def create_parser():
    ...
    #-----------------SEVIR--------------------
    parser.add_argument("--sevir_dataset_type",       type=str,   default='default', help='3 types, storm, random, default')
...
class Runner(object):
    ...
    def _load_data(self):
        ...
        train_data, valid_data , test_data , color_save_fn, PIXEL_SCALE, THRESHOLDS = get_dataset(
            ...
            sevir_type = self.args.sevir_dataset_type,
