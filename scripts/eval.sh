CUDA_VISIBLE_DEVICES=0 python3 run_alphapre_convlstm_sevir_lr_latent.py \
    ...
    --ckpt_milestone "/home/vatsal/NWM/Baselines_Precipitation_Nowcasting/Exps/meteo_lr_latent_32/alpha_afnoamplinet_latent_falfcl_meteo_lr_latent_32_Testing_Integrity_with_afno_amplinet_0.01_1.0_deterministic/checkpoints/ckpt-best.pt" \
    --eval \
