    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=0 python3 run_alphapre_convlstm_sevir_lr_latent.py \
                ...
                --run_name amplinet_latent_falfcl_only_2_3_13_2_gabor2_shanghai_${weight_scale}_${a}_${b}_${f}
            done
        done
    done
done
    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=0 python3 run_alphapre_convlstm_sevir_lr_latent.py \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_3Dconv_gabor2_cikm_${weight_scale}_${a}_${b}_${f}
            done
        done
    done
done
