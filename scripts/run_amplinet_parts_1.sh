CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent.py \
    --backbone amplinet_latent_falfcl_only_2.3.13.2_3Dconv \
    ...
    --run_name 'amplinet_latent_falfcl_only_2.3.13.3.4'
...
#     --wandb_state 'online' \
#     --wandb_project_name 'Alphapre' \
#     --run_name 'amplinet_latent_falfcl_only_2.3.2.5'
...
#     --wandb_state 'online' \
#     --wandb_project_name 'Alphapre' \
#     --run_name 'amplinet_latent_falfcl_only_2.3.13.1'
