    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent.py \
                --backbone amplinet_latent_falfcl_only_2_3_13_2_w_o_mlp_gabor2 \
                --dataset cikm_latent_32 \
                --exp_dir cikm_latent_32_model_parts \
                --exp_note "amplinet_latent_falfcl_only_2_3_13_2_w_o_mlp_gabor2_${weight_scale}_${a}_${b}_${f}" \
                ...
                --run_name amplinet_latent_falfcl_only_2_3_13_2_w_o_mlp_gabor2_cikm${weight_scale}_${a}_${b}_${f}
