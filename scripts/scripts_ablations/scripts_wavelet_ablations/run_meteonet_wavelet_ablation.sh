#!/bin/bash
# ============================================================
# Wavelet Ablation — MeteoNet
# Best: db6 L1 (skipped)
# 5 runs:
#   Best wavelet (db6) x other levels: L2, L3, L4
#   Best level (L1) x other wavelets:  db4, haar
# Server: .205 GPU → GPU 0, sequential
# ============================================================
...
EXP_DIR="wavelet_ablation_meteonet"
...
run_experiment() {
    ...
    echo "=============================================="
    echo "  GPU ${GPU} | MeteoNet | wave=${WAVE} L=${LEVEL}"
    echo "=============================================="
    ...
    echo "  Done: MeteoNet | wave=${WAVE} L=${LEVEL}"; echo ""
}

echo "=============================================="
echo "  MeteoNet Wavelet Ablation — 5 runs (GPU 0)"
echo "  Best: db6 L1 (skipped)"
echo "  db6 x [L2,L3,L4] | L1 x [db4,haar]"
echo "=============================================="
echo ""
...
# Best level (L1) x other wavelets
run_experiment ${GPU} db4  1
run_experiment ${GPU} haar 1

echo "=============================================="
echo "  MeteoNet wavelet ablation complete. Check wandb."
echo "=============================================="
