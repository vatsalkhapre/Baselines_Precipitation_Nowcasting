#!/bin/bash
# ============================================================
# Wavelet Ablation — Shanghai
# Best: db6 L3 (skipped)
# 5 runs:
#   Best wavelet (db6) x other levels: L1, L2, L4
#   Best level (L3) x other wavelets:  db4, haar
# Server: .66 GPU → GPU 1, sequential
# ============================================================
...
EXP_DIR="wavelet_ablation_shanghai"
...
run_experiment() {
    ...
    echo "=============================================="
    echo "  GPU ${GPU} | Shanghai | wave=${WAVE} L=${LEVEL}"
    echo "=============================================="
    ...
    echo "  Done: Shanghai | wave=${WAVE} L=${LEVEL}"; echo ""
}
...
# Best level (L3) x other wavelets
run_experiment ${GPU} db4  3
run_experiment ${GPU} haar 3

echo "=============================================="
echo "  Shanghai wavelet ablation complete. Check wandb."
echo "=============================================="
