#!/bin/bash
# ============================================================
<<<<<<<< HEAD:scripts/scripts_ablations/meteonet_ablations.sh
...
>>>>>>>> d977934 (some modifications acml):scripts/scripts_ablations/shanghai_ablations.sh
# ============================================================
...
run_gpu0() {
    run_experiment 2 ${ABL6}  "Original_model_with_const_gabor_params"
}

# run_gpu1() {
#     run_experiment 1 ${ABL4}  "abl4_no_conv_spectral"
# }
