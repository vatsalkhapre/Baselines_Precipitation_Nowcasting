...
#!/bin/bash
# =============================================================================
# Ablation: fixed hidden_dim=64, fixed kernels=[3,3,3]
# Sweep: lifting / projection channel schedules on CIKM
# =============================================================================
#!/bin/bash
