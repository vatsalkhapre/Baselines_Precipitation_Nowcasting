...
# run_gpu0() {
#     run_experiment 0 "${CIKM}" 1 1
#     run_experiment 0 "${CIKM}" 2 1
#     run_experiment 0 "${CIKM}" 4 1
# }

# run_gpu1() {
#     run_experiment 1 "${CIKM}" 2 2
...
METEONET="meteo_lr_latent_32|25|5|20|/home/vatsal/NWM/Baselines_Precipitation_Nowcasting/Pretrained_ae_checkpoints/autoencoder_checkpoint_32_METEONET.pth|wavelet_verification"
...
echo "=============================================="
echo "  Wavelet Verification — 4 runs on GPU 0"
echo "  db4 J2 sep → db4 J3 sep → db6 J2 sep → db6 J3 sep"
echo "=============================================="
echo ""

# run_experiment 0 "${METEONET}" db4 1 separate
# run_experiment 0 "${METEONET}" db4 3 separate
run_experiment 0 "${METEONET}" db6 1 separate
# run_experiment 0 "${METEONET}" db6 3 separate

echo "=============================================="
echo "  All runs complete. Check wandb."
echo "=============================================="