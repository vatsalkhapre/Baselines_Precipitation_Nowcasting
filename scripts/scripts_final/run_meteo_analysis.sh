...
run_experiment() {
    ...
    echo "=============================================="
    echo "  GPU ${GPU} | MeteoNet | seed=${SEED}"
    echo "=============================================="
    ...
    echo "  Done: MeteoNet | seed=${SEED}"; echo ""
}
...
echo "=============================================="
echo "  Multi-Seed — MeteoNet (2 GPUs parallel)"
...
echo ""
echo "=============================================="
echo "  MeteoNet multi-seed runs complete. Check wandb."
echo "=============================================="