                                    ...
                                    do 
                                        ...
                                        do
                                            ...
                                            do
                                                ...
                                                do
                                                CUDA_VISIBLE_DEVICES=2 python3 run_alphapre_convlstm_sevir_lr_latent_model_novelty.py \
                                                    ...
                                                    --run_name AFNO2D_relu_waveletafnogabor_SHANGHAI_${afno_blocks}_${afno2D_hidden_size_factor}_${sparsity_threshold}
