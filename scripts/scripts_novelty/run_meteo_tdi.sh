                            ...
                            do
                                ...
                                do 
                                    ...
                                    CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_model_novelty.py \
                                        ...
                                        --run_name conv_less_full_mlp_tdi_waveletsgabor2_bestMETEONETparams_METEONET
                                        ...
                                        do
                                            ...
                                            do
                                                ...
                                                CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_model_novelty.py \
                                                    ...
                                                    --wandb_state 'online' \
                                                    --wandb_project_name 'Alphapre' \
                                                    --run_name METEONET_AFNO2D_relu_tdi_waveletafnogabor2_${afno_blocks}_${afno2D_hidden_size_factor}_${sparsity_threshold}
    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent.py \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_tdi_gabor2_METEONET
