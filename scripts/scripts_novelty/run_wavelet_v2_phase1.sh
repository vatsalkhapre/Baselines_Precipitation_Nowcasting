...
BACKBONE="amplinet_latent_falfcl_only_2_3_13_2_gabor_convwavelets"
SEED=0

# Fixed Gabor params
WS=1.5; A=1.0; B=1.0; F=1.0
...
EXP_DIR="cikm_latent_32_wavelet_v2_search"
...
echo "=============================================="
echo "  Wavelet LASTOCast V2 — Phase 1"
