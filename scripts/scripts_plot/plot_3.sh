...
CUDA_VISIBLE_DEVICES=0 python3 run_alphapre_convlstm_sevir_lr_latent_with_plotting_consecutive.py \
      ...
      --num_workers 8 \
      --plot_stride 10 \
      --ckpt_milestone /home/vatsal/Dataserver2/ECCV26/Best_models/shanghai_latent/amplinet_latent_falfcl_only_2_3_13_2_supplimentrygabor2_shanghai_lr_latent_32_amplinet_latent_falfcl_only_2_3_13_2_supplimentrygabor2_dim_128/checkpoints/ckpt-best.pt \
