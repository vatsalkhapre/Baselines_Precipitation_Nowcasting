...
CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_with_plotting_consecutive.py \
      ...
      --num_workers 8 \
      --plot_stride 40 \
      --ckpt_milestone /home/vatsal/Dataserver2/ECCV26/Best_models/sevir_latent/amplinet_latent_falfcl_only_2_3_13_2_gabor2_sevir_lr_latent_32_amplinet_latent_falfcl_only_2_3_13_2_gabor2_1.5_1.0_1.0_2.0/checkpoints/ckpt-best.pt \
