    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent.py \
                ...
                --run_name amplinet_latent_falfcl_only_2_3_13_2_MLP_residual_gabor2_cikm_${weight_scale}_${a}_${b}_${f}
    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent.py \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_MLP_residual_gabor2_shanghai_${weight_scale}_${a}_${b}_${f}
    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent.py \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_MLP_residual_gabor2_meteonet_${weight_scale}_${a}_${b}_${f}
...
#     --wandb_state 'online' \
#     --wandb_project_name 'Alphapre' \
#     --run_name FNO_Ablation_meteonet_${weight_scale}_${a}_${b}_${f}
...
#     --wandb_state 'offline' \
#     --wandb_project_name 'Alphapre' \
#     --run_name FNO_Ablation_shanghai_${weight_scale}_${a}_${b}_${f}
