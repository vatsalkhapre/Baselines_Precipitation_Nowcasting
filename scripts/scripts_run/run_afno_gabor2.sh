for weight_scale in 0.5 1.25 1.5 2.0
do
    for a in 1.0
    do 
        for b in 1.0
        do
            ...
            do
                ...
                CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_3.py \
                    ...
                    --run_name amplinet_latent_falfcl_only_2_3_13_2_AFNO2D_AFNO3D_relu_afnogabor2_cikm${weight_scale}_${a}_${b}_${f}_${blocks}
