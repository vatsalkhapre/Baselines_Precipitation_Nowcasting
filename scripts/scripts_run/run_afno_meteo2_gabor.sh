...
<<<<<<< HEAD
                        CUDA_VISIBLE_DEVICES=0 python3 run_alphapre_convlstm_sevir_lr_latent_3.py \
                            ...
                            --exp_note "amplinet_latent_falfcl_only_2_3_13_2_AFNO2D_AFNO3D_convparallel_relu_afnogabor2_${weight_scale}_${a}_${b}_${f}_${blocks}_${hf}_${st}" \
                            ...
                            --run_name amplinet_latent_falfcl_only_2_3_13_2_AFNO2D_AFNO3D_convparallel_relu_afnogabor2_meteonet${weight_scale}_${a}_${b}_${f}_${blocks}_${hf}_${st}
=======
