...
EXP_NOTE="dawncast_transfer_temporal_path_shanghai"
RUN_NAME="DAWNCast_transfer_temporal_path_shanghai_latent"
...
TARGET_TAG="shanghai"                # tags the lightweight adapter checkpoint
