#!/bin/bash
# ============================================================
# DAWNCast (old block) — Shanghai Gabor frequency sweep, PIXEL SPACE
#
...
# ---- Experiment ---------------------------------------------
EXP_DIR="gabor_exp_shanghai_pixel"
EPOCHS=50
SEED=0
...
SPECTRAL_HIDDEN_SIZE_FACTOR=3     # ... --afno2D_hidden_size_factor
...
run_experiment() {
    ...
    local TAG="Shanghai_pixel_flow${F_LOW}_fhigh${F_HIGH}"
    local RUN_NAME="${BACKBONE}_${DATASET}_${TAG}"

    echo "=============================================="
    echo "GPU ${GPU} | Shanghai pixel | flow=${F_LOW} | fhigh=${F_HIGH}"
    echo "=============================================="
...
FLOWS=(3.28 8.74 17.49 34.33)
FHIGHS=(0.14 0.42 1.12 2.25 4.43)
...
echo "All Shanghai pixel-space experiments completed."
