...
RUN_NAME="DAWNCast_latent_sevir_shared_gabor_parameters_highfreq"
...
# # ---- Experiment ----------------------------------------------
# EXP_DIR="shanghai_lr_latent_32"
# EXP_NOTE="dawncast_latent"
# RUN_NAME="DAWNCast_latent_shanghai"
...
# # ---- Autoencoder checkpoint ----------------------------------
# AE_CKPT_PATH="/home/vatsal/NWM/Baselines_Precipitation_Nowcasting/Pretrained_ae_checkpoints/autoencoder_checkpoint_32_SHANGHAI.pth"  # <-- SET THIS
