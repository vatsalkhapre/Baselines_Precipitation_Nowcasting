...
# Dataset : Meteonet          | GPU 0
# Config  : flow=1.09, fhigh=1.12  (best point from
#           run_freq_sweep_meteonet.sh)
# ==============================================================
...
# ---- Experiment ----------------------------------------------
EXP_DIR="dawncast_pixel_meteo"
EXP_NOTE="Meteonet_pixel_flow1.09_fhigh1.12"
RUN_NAME="DAWNCast_pixel_meteo_flow1.09_fhigh1.12"
EPOCHS=50
SEED=0

# ---- Dataset -------------------------------------------------
DATASET="meteo"                   # sevir | meteo | shanghai | cikm
IMG_SIZE=128
IMG_CHANNEL=1
FRAMES_IN=5
FRAMES_OUT=20
...
WAVELET_LEVEL=1                   # DWT decomposition levels J (1-4)
...
echo "Meteonet pixel-space DAWNCast run completed (GPU ${GPUS})."
