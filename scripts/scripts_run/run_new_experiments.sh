...
#                     --run_name amplinet_latent_falfcl_only_2_3_13_2_conv_by_conv2Dspectralgabor2_cikm${weight_scale}_${a}_${b}_${f}_${m}
...
#                     --wandb_state 'offline' \
#                     --wandb_project_name 'Alphapre' \
#                     --run_name amplinet_latent_falfcl_only_2_3_13_2_conv3D_by_conv3Dspectralgabor2_cikm${weight_scale}_${a}_${b}_${f}_${m}
    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_3.py \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_more_conv_gabor2_cikm${weight_scale}_${a}_${b}_${f}_${m}
    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_3.py \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_more_conv_residual_gabor2_cikm${weight_scale}_${a}_${b}_${f}_${m}
    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_3.py \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_more_gabor_gabor2_cikm${weight_scale}_${a}_${b}_${f}_${m}
    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_3.py \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_more_gabor_n_its_residual_gabor2_cikm${weight_scale}_${a}_${b}_${f}_${m}
    ...
    do 
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_3.py \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_residual_with_fusion_gabor2_cikm${weight_scale}_${a}_${b}_${f}_${m}
...
do
    ...
    do 
        ...
        do
            ...
            do
            CUDA_VISIBLE_DEVICES=1 python3 run_alphapre_convlstm_sevir_lr_latent_3.py \
                --backbone amplinet_latent_falfcl_only_2_3_13_2_AFNO2D_AFNO3D_learnable_freqmulti_gabor2 \
                --dataset cikm_latent_32 \
                --exp_dir cikm_new_experiments \
                --exp_note "amplinet_latent_falfcl_only_2_3_13_2_AFNO2D_AFNO3D_learnable_freqmulti_gabor2_${weight_scale}_${a}_${b}_${f}_${m}" \
                --ae_ckpt_path "/home/vatsal/NWM/Baselines_Precipitation_Nowcasting/Pretrained_ae_checkpoints/autoencoder_checkpoint_32_CIKM.pth" \
                --epochs 50 \
                --valid \
                --seq_len 15 \
                ...
                --wandb_state 'online' \
                --wandb_project_name 'Alphapre' \
                --run_name amplinet_latent_falfcl_only_2_3_13_2_AFNO2D_AFNO3D_learnable_freqmulti_gabor2_cikm${weight_scale}_${a}_${b}_${f}_${m}
