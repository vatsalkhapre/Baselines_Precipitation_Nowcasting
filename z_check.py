...
def create_parser():
    ...
    parser.add_argument("--exp_note",       type=str,   default='amplinet_latent_falfcl_only',              help="additional note for experiment")
    ...
    parser.add_argument("--run_name",       type=str,   default='Amplinet_falfcl_only_shanghai_latent_32',        help="wandb run name")
